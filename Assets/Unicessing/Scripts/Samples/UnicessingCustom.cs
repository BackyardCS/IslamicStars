...
public class UnicessingCustom : UGraphics
{
    ...
    protected override void Setup()
    {
        ...
        littleStar = createShape();
        littleStar.beginShape(UShape.VertexType.TRIANGLE_FAN);
        littleStar.shader(UMaterials.getStrokeMaterial(UMaterials.BlendMode.Opaque));
        littleStar.isClockwise = false;
        littleStar.fill(Color.yellow);
        littleStar.vertex(0.0f, 0.0f);
        littleStar.fill(Color.cyan);
        littleStar.vertex(0.0f, -0.5f);
        littleStar.vertex(0.14f, -0.20f);
        littleStar.vertex(0.47f, -0.15f);
        littleStar.vertex(0.23f, 0.07f);
        littleStar.vertex(0.29f, 0.40f);
        littleStar.fill(Color.green);
        littleStar.vertex(0.0f, 0.25f);
        littleStar.vertex(-0.29f, 0.4f);
        littleStar.vertex(-0.23f, 0.07f);
        littleStar.vertex(-0.47f, -0.15f);
        littleStar.vertex(-0.14f, -0.2f);
        littleStar.vertex(0.0f, -0.5f);
        littleStar.endShape();
