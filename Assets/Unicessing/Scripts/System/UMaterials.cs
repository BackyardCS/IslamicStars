...
#if UNITY_STANDALONE  
            // GPUインスタンシングあり
            fillMaterials[(int)BlendMode.Opaque] = load("Unicessing/Materials/FillOpaqueInstanced");
            //fillMaterials[(int)BlendMode.Transparent] = instance.load("Unicessing/Materials/FillTransInstanced");
            fillMaterials[(int)BlendMode.Transparent] = load("Unicessing/Materials/FillTrans");
            fillMaterials[(int)BlendMode.Add] = load("Unicessing/Materials/FillAddInstanced");
#else
            fillMaterials[(int)BlendMode.Opaque] = load("Unicessing/Materials/FillOpaque");
            fillMaterials[(int)BlendMode.Transparent] = load("Unicessing/Materials/FillTrans");
            fillMaterials[(int)BlendMode.Add] = load("Unicessing/Materials/FillAdd");
#endif

            fillUnlitMaterials[(int)BlendMode.Opaque] = load("Unicessing/Materials/FillUnlitOpaque");
            fillUnlitMaterials[(int)BlendMode.Transparent] = load("Unicessing/Materials/FillUnlitTrans");
            fillUnlitMaterials[(int)BlendMode.Add] = load("Unicessing/Materials/FillUnlitAdd");

            // line、pointなど頂点カラー使用
            strokeMaterials[(int)BlendMode.Opaque] = load("Unicessing/Materials/StrokeOpaque");
            strokeMaterials[(int)BlendMode.Transparent] = load("Unicessing/Materials/StrokeTrans");
            strokeMaterials[(int)BlendMode.Add] = load("Unicessing/Materials/StrokeAdd");
        }
